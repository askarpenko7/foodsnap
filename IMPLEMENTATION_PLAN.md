...
| Phase 4 — design build-out (optional) | 2/6 | 0/0 | 0/3 | in progress |

**Now:** P4.3 · **Phases 1, 2 and 3 are all complete**, DoD included. **Next up:** P4.3 (portion editor + Add to diary).
